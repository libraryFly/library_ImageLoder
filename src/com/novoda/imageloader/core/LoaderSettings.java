...
import com.novoda.imageloader.core.loader.LIFOLoader;
...
public class LoaderSettings {
    ...
    private static final TaskType DEFAULT_TASK_TYPE = TaskType.AsyncTask;
    ...
    public Loader getLoader() {
        if (loader == null) {
            if (getTaskType()==TaskType.SingleTask) {
            	this.loader = new SimpleLoader(this);
            } else if(getTaskType()==TaskType.LIFOAsyncTask){
            	 this.loader = new LIFOLoader(this);
            }else{
    ...
    public static class SettingsBuilder {
        ...
        public SettingsBuilder withTaskType(TaskType taskType) {
            settings.setTaskType(taskType);
            return this;
        }
