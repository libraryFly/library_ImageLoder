...
public class LIFOLoaderTask extends LIFOAsyncTask<String, Void, Bitmap> {
    ...
    public LIFOLoaderTask(ImageWrapper imageWrapper, LoaderSettings loaderSettings) {
        this(imageWrapper, loaderSettings, null);
    }

    public LIFOLoaderTask(ImageWrapper imageWrapper, LoaderSettings loaderSettings, WeakReference<OnImageLoadedListener> onImageLoadedListener) {
