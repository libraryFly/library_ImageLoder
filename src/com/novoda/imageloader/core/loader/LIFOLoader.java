...
import com.novoda.imageloader.core.loader.util.LIFOLoaderTask;
import com.novoda.imageloader.core.model.ImageWrapper;

import java.lang.ref.WeakReference;

public class LIFOLoader implements Loader {

    private final LoaderSettings loaderSettings;
    private WeakReference<OnImageLoadedListener> onImageLoadedListener;

    public LIFOLoader(LoaderSettings loaderSettings) {
    ...
    private void startTask(ImageWrapper w) {
        try {
        	...
        	LIFOLoaderTask task = createTask(w);
            task.execute();
    ...
    private LIFOLoaderTask createTask(ImageWrapper imageWrapper) {
        return onImageLoadedListener == null ? new LIFOLoaderTask(imageWrapper, loaderSettings)
                : new LIFOLoaderTask(imageWrapper, loaderSettings, onImageLoadedListener);
    }
